...
class _FeedScreenState extends State<FeedScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<FeedBloc>().add(LoadInitialFeedEvent());
    });
  ...
  Future<void> _runAutomatedStressBenchmark() async {
    ...
    try {
      ...
      for (final cat in ['Systems', 'AI & ML', 'Cloud', 'All']) {
        bloc.add(FilterCategoryEvent(cat == 'All' ? null : cat));
  ...
  void _showBenchmarkResults(Map<String, dynamic> report) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: const Row(
          children: [
            Icon(Icons.analytics_outlined, color: Color(0xFFFF5252)),
            SizedBox(width: 8),
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text("Architecture: ${report['architecture']}", style: const TextStyle(color: Color(0xFFFF7A7A), fontWeight: FontWeight.bold)),
        ...
        actions: [
          TextButton(
            ...
            child: const Text("CLOSE", style: TextStyle(color: Color(0xFFFF5252))),
          ),
        ],
      ),
    );
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: const Column(
              ...
              children: [
                ...
                Text("App 3: BLoC Architecture", style: TextStyle(fontSize: 11, color: Color(0xFFFF7A7A))),
              ],
            ),
            actions: [
              IconButton(
          ...
          body: Column(
            children: [
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Padding(
                      ...
                      child: FilterChip(
                        ...
                        onSelected: (_) => context.read<FeedBloc>().add(FilterCategoryEvent(cat == 'All' ? null : cat)),
                      ),
                    );
                  },
                ),
              ...
              Expanded(
                child: state.status == FeedStatus.loading && articles.isEmpty
                                    ...
                                    Row(
                                      children: [
                                        Container(
                                          ...
                                          child: Text(
                                            item.category,
                                            style: const TextStyle(color: Color(0xFFFF7A7A), fontSize: 10, fontWeight: FontWeight.bold),
                                          ),
                                        ),
                                        const Spacer(),
                                        IconButton(
