      ...
      appBar: AppBar(
        ...
        title: const Column(
          ...
          children: [
            ...
            Text("BLoC Stream CPU & Memory Profiler", style: TextStyle(fontSize: 11, color: Color(0xFFFF7A7A))),
          ],
        ),
        actions: [
          IconButton(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    const Row(
                      children: [
                        Icon(Icons.developer_board, color: Color(0xFFFF5252), size: 18),
                        SizedBox(width: 8),
                    ...
                    Row(
                      ...
                      children: [
                        _labMetric("Current CPU", "${currentCpu.toStringAsFixed(1)}%", const Color(0xFFFF5252)),
                        _labMetric("Peak CPU", "${peakCpu.toStringAsFixed(1)}%", Colors.orangeAccent),
                        _labMetric("UI Thread Active", "${uiCpuMs.toStringAsFixed(0)} ms", const Color(0xFFFF7A7A)),
                        _labMetric("Thread Model", "BLoC Stream Loop", Colors.white70),
                      ],
                    ),
                  ],
                ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    const Row(
                      children: [
                        Icon(Icons.speed, color: Color(0xFFFF5252), size: 18),
                        SizedBox(width: 8),
