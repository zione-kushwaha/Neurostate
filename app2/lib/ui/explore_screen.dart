...
class ExploreScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final categories = [
      {'name': 'AI & ML', 'icon': Icons.psychology, 'color': const Color(0xFF00C896), 'desc': 'Deep Learning, Transformers & Edge AI'},
      ...
      appBar: AppBar(
        ...
        title: const Column(
          ...
          children: [
            ...
            Text("Riverpod Multi-Provider Graph", style: TextStyle(fontSize: 11, color: Color(0xFF00E6AC))),
          ],
        ),
      ),
      body: Column(
                ...
                GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return InkWell(
                      ...
                      onTap: () {
                        ref.read(feedNotifierProvider.notifier).setCategory(name);
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      leading: CircleAvatar(
                        backgroundColor: const Color(0xFF00C896).withAlpha(40),
                        child: Text(author[0], style: const TextStyle(color: Color(0xFF00C896), fontWeight: FontWeight.bold)),
                      ),
