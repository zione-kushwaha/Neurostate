      ...
      appBar: AppBar(
        ...
        title: const Column(
          ...
          children: [
            ...
            Text("Riverpod CPU & Performance Profiler", style: TextStyle(fontSize: 11, color: Color(0xFF00E6AC))),
          ],
        ),
        actions: [
          IconButton(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: const Color(0xFF00C896).withAlpha(120)),
                ),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Row(
                      children: [
                        Icon(Icons.developer_board, color: Color(0xFF00C896), size: 18),
                        SizedBox(width: 8),
                    ...
                    Row(
                      ...
                      children: [
                        _labMetric("Current CPU", "${currentCpu.toStringAsFixed(1)}%", const Color(0xFF00C896)),
                        _labMetric("Peak CPU", "${peakCpu.toStringAsFixed(1)}%", Colors.orangeAccent),
                        _labMetric("UI Thread Active", "${uiCpuMs.toStringAsFixed(0)} ms", const Color(0xFF00E6AC)),
                        _labMetric("Thread Model", "Riverpod Notifier", Colors.white70),
                      ],
                    ),
                  ],
                ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    const Row(
                      children: [
                        Icon(Icons.speed, color: Color(0xFF00C896), size: 18),
                        SizedBox(width: 8),
              ...
              if (_lastTestSummary != null) ...[
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: const Color(0xFF00C896).withAlpha(100)),
                  ),
                  child: Text(
                    _lastTestSummary!,
