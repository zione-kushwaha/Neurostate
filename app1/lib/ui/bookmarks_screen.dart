...
class BookmarksScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bookmarkedArticles = provider.articles.where((a) => provider.bookmarkedIds.contains(a.id)).toList();
      ...
      appBar: AppBar(
        ...
        title: const Column(
          ...
          children: [
            ...
            Text("Synchronized Reactive State", style: TextStyle(fontSize: 11, color: Color(0xFF8A84FF))),
          ],
        ),
        actions: [
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Padding(
                            ...
                            child: Row(
                              children: [
                                Text(item.category, style: const TextStyle(color: Color(0xFF8A84FF), fontSize: 11)),
