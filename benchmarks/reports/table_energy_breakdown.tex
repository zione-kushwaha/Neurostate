...
\bottomrule
\multicolumn{7}{l}{\footnotesize Subsystem drain estimated via Android \texttt{dumpsys batterystats} and \texttt{power\_profile.xml} modeling; not measured with an external hardware power analyzer.} \\
\end{tabular}
}
\end{table*}
