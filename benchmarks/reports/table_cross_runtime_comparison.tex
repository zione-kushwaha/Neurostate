...
\bottomrule
\multicolumn{10}{l}{\footnotesize Evaluated on identical 5-screen topologies and 10,000 articles ($23.65$\,MB). Battery drain estimated via Android \texttt{dumpsys batterystats} and \texttt{power\_profile.xml}.} \\
\end{tabular}
}
\end{table*}
